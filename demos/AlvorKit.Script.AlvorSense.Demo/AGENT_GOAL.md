...
This project is an interactive practice target for AlvorSense through
`AgentGlfwWindowHost`.
...
4. Type the code `KIT`; the three orange code lights should fill in.
...
confirming the win, quit the game and report the `ALVORSENSE_DEMO_RESULT` JSON
printed by stdout.
