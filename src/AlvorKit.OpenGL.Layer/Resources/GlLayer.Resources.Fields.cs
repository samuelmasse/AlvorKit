...
public unsafe partial class GlLayer
{
    ...
    private readonly GlResourceSet<GlTextureHandle> textures = new("texture");

    /// <summary>Tracks live buffer handles owned by this layer.</summary>
    private readonly GlResourceSet<GlBufferHandle> buffers = new("buffer");

    /// <summary>Tracks live vertex array handles owned by this layer.</summary>
    private readonly GlResourceSet<GlVertexArrayHandle> vertexArrays = new("vertex array");

    /// <summary>Tracks live framebuffer handles owned by this layer.</summary>
    private readonly GlResourceSet<GlFramebufferHandle> framebuffers = new("framebuffer");

    /// <summary>Tracks live renderbuffer handles owned by this layer.</summary>
    private readonly GlResourceSet<GlRenderbufferHandle> renderbuffers = new("renderbuffer");

    /// <summary>Tracks live sampler handles owned by this layer.</summary>
    private readonly GlResourceSet<GlSamplerHandle> samplers = new("sampler");

    /// <summary>Tracks live query handles owned by this layer.</summary>
    private readonly GlResourceSet<GlQueryHandle> queries = new("query");

    /// <summary>Tracks live program pipeline handles owned by this layer.</summary>
    private readonly GlResourceSet<GlProgramPipelineHandle> programPipelines = new("program pipeline");

    /// <summary>Tracks live transform feedback handles owned by this layer.</summary>
    private readonly GlResourceSet<GlTransformFeedbackHandle> transformFeedbacks = new("transform feedback");

    /// <summary>Tracks live shader handles owned by this layer.</summary>
    private readonly GlResourceSet<GlShaderHandle> shaders = new("shader");

    /// <summary>Tracks live program handles owned by this layer.</summary>
    private readonly GlResourceSet<GlProgramHandle> programs = new("program");
