...
public partial class GlLayer
{
    ...
    {
        clipControl.Set(nameof(ClipControl), (origin, depth));
    ...
    {
        patchParameterMap.Set(nameof(PatchParameteri), pname, value);
    ...
    {
        pointParameterMap.Set(nameof(PointParameterf), pname, param);
    ...
    {
        pointParameterMap.Set(nameof(PointParameteri), pname, param);
    ...
    {
        transformFeedbackActive.Set(nameof(BeginTransformFeedback), primitiveMode);
