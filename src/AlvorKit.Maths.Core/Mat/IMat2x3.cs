...
/// <summary>Applies to 2x3 matrix types.</summary>
...
public interface IMat2x3<TSelf, TScalar, TColumn, TRow, TTranspose> :
    IMatNumeric<TSelf, TScalar, TColumn, TRow, TTranspose>
    where TSelf : struct, IMat2x3<TSelf, TScalar, TColumn, TRow, TTranspose>
