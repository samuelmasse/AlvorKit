...
public interface IMat2<TSelf, TScalar, TColumn, TRow, TTranspose> :
    IMatSquare<TSelf, TScalar, TColumn>
    where TSelf : struct, IMat2<TSelf, TScalar, TColumn, TRow, TTranspose>
    ...
    where TTranspose : struct
{
    ...
    static abstract TSelf CreateRows(TRow row0, TRow row1);
}
