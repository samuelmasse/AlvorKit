...
/// <summary>Applies to 4x2 matrix types.</summary>
...
public interface IMat4x2<TSelf, TScalar, TColumn, TRow, TTranspose> :
    IMatNumeric<TSelf, TScalar, TColumn, TRow, TTranspose>
    where TSelf : struct, IMat4x2<TSelf, TScalar, TColumn, TRow, TTranspose>
