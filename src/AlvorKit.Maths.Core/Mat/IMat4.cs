...
/// <summary>Applies to 4x4 square matrix types.</summary>
...
public interface IMat4<TSelf, TScalar, TColumn, TRow, TTranspose> :
    IMatSquare<TSelf, TScalar, TColumn>
    where TSelf : struct, IMat4<TSelf, TScalar, TColumn, TRow, TTranspose>
