...
/// <summary>Applies to 3x3 matrix types that can be created from matching quaternions.</summary>
/// <typeparam name="TSelf">The 3x3 matrix type.</typeparam>
...
public interface IMat3QuaternionRotation<TSelf, TScalar, TVector3, TQuaternion, TMatrix4> :
    ...
    where TSelf : struct, IMat3QuaternionRotation<TSelf, TScalar, TVector3, TQuaternion, TMatrix4>
    where TVector3 : struct, IVec3<TVector3, TScalar>
    where TQuaternion : struct, IQuatRotation<TQuaternion, TScalar, TVector3, TSelf, TMatrix4>
{
