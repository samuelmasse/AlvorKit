...
{
    /// <summary>Writes a warning entry containing exception details.</summary>
    ...
    /// <summary>Writes a warning message and optional exception details.</summary>
    [OverloadResolutionPriority(1)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Writes one typed value as a warning entry.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Writes a warning entry from one typed format argument.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Writes a warning entry from two typed format arguments.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Writes a warning entry from three typed format arguments.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Writes a warning entry from four typed format arguments.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Writes a warning entry from five typed format arguments.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Writes a warning entry from six typed format arguments.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Writes a warning entry from seven typed format arguments.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Writes a warning entry from eight typed format arguments.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Gets whether warning entries are disabled by the current threshold.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private bool SkipWarn() => (LogLevel)Volatile.Read(ref level) < LogLevel.Warn;

    /// <summary>Opens a warning entry and appends its prefix.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private void StartWarn(string file, int line, out DateTime time, out LogEntryText sb)
    {
        sb = Open();
        LogFormat.StartWarn(file, line, ref sb, out time);
    }

    /// <summary>Commits a completed warning entry.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private void EndWarn(string file, int line, DateTime time, LogEntryText sb) =>
