...
public static class GlUIntUniformMathsExtensions
{
    ...
    public static void ProgramUniform2uiv(this Gl gl, GlProgramHandle program, int location, ReadOnlySpan<Vec2u> values) => gl.ProgramUniform2uiv(program, location, MemoryMarshal.Cast<Vec2u, uint>(values));
    ...
    public static void ProgramUniform3ui(this Gl gl, GlProgramHandle program, int location, Vec3u value) => gl.ProgramUniform3ui(program, location, value.X, value.Y, value.Z);
    /// <summary>Calls <see cref="Gl.ProgramUniform3uiv(GlProgramHandle, int, ReadOnlySpan{uint})"/> for <c>glProgramUniform3uiv</c>.</summary>
    public static void ProgramUniform3uiv(this Gl gl, GlProgramHandle program, int location, ReadOnlySpan<Vec3u> values) => gl.ProgramUniform3uiv(program, location, MemoryMarshal.Cast<Vec3u, uint>(values));
    ...
    public static void ProgramUniform4ui(this Gl gl, GlProgramHandle program, int location, Vec4u value) => gl.ProgramUniform4ui(program, location, value.X, value.Y, value.Z, value.W);
    /// <summary>Calls <see cref="Gl.ProgramUniform4uiv(GlProgramHandle, int, ReadOnlySpan{uint})"/> for <c>glProgramUniform4uiv</c>.</summary>
    public static void ProgramUniform4uiv(this Gl gl, GlProgramHandle program, int location, ReadOnlySpan<Vec4u> values) => gl.ProgramUniform4uiv(program, location, MemoryMarshal.Cast<Vec4u, uint>(values));
}
