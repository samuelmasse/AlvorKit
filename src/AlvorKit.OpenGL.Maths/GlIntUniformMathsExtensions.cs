...
public static class GlIntUniformMathsExtensions
{
    ...
    public static void ProgramUniform2iv(this Gl gl, GlProgramHandle program, int location, ReadOnlySpan<Vec2i> values) =>
        gl.ProgramUniform2iv(program, location, MemoryMarshal.Cast<Vec2i, int>(values));
    ...
    public static void ProgramUniform3i(this Gl gl, GlProgramHandle program, int location, Vec3i value) =>
        gl.ProgramUniform3i(program, location, value.X, value.Y, value.Z);
    /// <summary>Calls <see cref="Gl.ProgramUniform3iv(GlProgramHandle, int, ReadOnlySpan{int})"/> for <c>glProgramUniform3iv</c>.</summary>
    public static void ProgramUniform3iv(this Gl gl, GlProgramHandle program, int location, ReadOnlySpan<Vec3i> values) =>
        gl.ProgramUniform3iv(program, location, MemoryMarshal.Cast<Vec3i, int>(values));
    ...
    public static void ProgramUniform4i(this Gl gl, GlProgramHandle program, int location, Vec4i value) =>
        gl.ProgramUniform4i(program, location, value.X, value.Y, value.Z, value.W);
    /// <summary>Calls <see cref="Gl.ProgramUniform4iv(GlProgramHandle, int, ReadOnlySpan{int})"/> for <c>glProgramUniform4iv</c>.</summary>
    public static void ProgramUniform4iv(this Gl gl, GlProgramHandle program, int location, ReadOnlySpan<Vec4i> values) =>
        gl.ProgramUniform4iv(program, location, MemoryMarshal.Cast<Vec4i, int>(values));
}
