...
{
    /// <summary>Gets the generated capsule type name.</summary>
    public string TypeName => Scalar.CapsuleName();
    ...
    /// <summary>Gets the matching 3D segment type name.</summary>
    public string Segment3TypeName => Scalar.SegmentName();
    ...
    public int SizeBytes => Scalar.SizeBytes * 7;
}
