...
public sealed class BindingCodeEmitter(BindgenConfig config, string tag)
{
    ...
    public void Emit(BindingModel model, string repoRoot, string bindingVersion, string nativeVersion)
    {
        ...
        File.WriteAllText(Path.Combine(apiDirectory, apiProjectName + ".csproj"), EmitApiProject(bindingVersion, unsafeBlocks));
        File.WriteAllText(Path.Combine(backendDirectory, backendProjectName + ".csproj"), EmitBackendProject(bindingVersion, nativeVersion, apiProjectName));
    ...
    private string EmitBackendProject(string bindingVersion, string nativeVersion, string apiProjectName) => $"""
        {XmlBanner()}
        <Project Sdk="Microsoft.NET.Sdk">
            ...
            <ItemGroup>
                <PackageReference Include="{config.Namespace}.Native" Version="{nativeVersion}" />
            </ItemGroup>
