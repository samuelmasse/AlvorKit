...
/// <param name="Rid">Optional runtime identifier supplied to target-specific commands.</param>
internal sealed record CliRequest(CliCommand Command, string? Selection, string? Rid);
