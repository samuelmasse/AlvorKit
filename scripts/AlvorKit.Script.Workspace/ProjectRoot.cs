...
{
    /// <summary>The authored package properties file that marks the repository root.</summary>
    public const string MarkerFileName = "AlvorKit.Packages.props";
    ...
    public static string FindFrom(string startPath, bool requireResDirectory) =>
        RepositoryRoot.FindMarkedFrom(startPath, MarkerFileName, requireResDirectory);
    ...
    public static string FindFromCurrentProcess(Type? anchor = null, bool requireResDirectory = false) =>
        RepositoryRoot.FindMarkedFromCurrentProcess(MarkerFileName, anchor, requireResDirectory);
    ...
    internal static string FindFromCandidates(IEnumerable<string?> startPaths, bool requireResDirectory = false)
        => RepositoryRoot.FindFromCandidates(startPaths, MarkerFileName, requireResDirectory);
